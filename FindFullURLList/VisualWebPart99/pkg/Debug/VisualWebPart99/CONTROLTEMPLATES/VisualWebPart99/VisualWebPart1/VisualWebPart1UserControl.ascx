<%@ Assembly Name="VisualWebPart99, Version=1.0.0.0, Culture=neutral, PublicKeyToken=202c814ada3428ce" %>
...
<asp:UpdatePanel runat="server">
    <ContentTemplate>
        ...
        <asp:Button class="ExecuteButton" runat="server" Text="Найти" OnClick="ExecuteButton_OnClick"/>
...
<asp:Button ID="RedirectButton" runat="server" Text="Перейти на страницу" OnClick="RedirectButton_OnClick"/>
